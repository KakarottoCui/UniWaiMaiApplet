		...
		<u-form :model="form" ref="uForm">
			...
			<view class="u-flex u-m-t-25 u-border-bottom">
				...
				<view class="u-flex u-m-l-20 u-p-b-25 u-border-bottom">
					<view class="item">
						<ygy-upload-img title="详情图一" :size="200" :num="1" :iconCloseStyle="info.iconCloseStyle"
							@saveImg="getImgList($event,'pic2')"></ygy-upload-img>
					</view>
				</view>
				<view class="u-flex u-m-l-20 u-p-b-25 u-border-bottom">
					<view class="item">
						<ygy-upload-img title="详情图二" :size="200" :num="1" :iconCloseStyle="info.iconCloseStyle"
